...
//
// $Id: TopObjectResolutionCalc.cc,v 1.5.2.1 2007/08/24 13:52:26 delaer Exp $
//
...
void  TopObjectResolutionCalc::operator()(TopTau& obj){
  ...
  if(useNN) {
    ...
    int bin = this->getEtaBin(theJet.eta());
    obj.setResA(     this->getObsRes(0,bin,theJet.et()) );
    obj.setResB(     this->getObsRes(1,bin,theJet.et()) );
    obj.setResC(     this->getObsRes(2,bin,theJet.et()) );	
    obj.setResD(     this->getObsRes(3,bin,theJet.et()) );	
    obj.setResTheta( this->getObsRes(4,bin,theJet.et()) );	 
    obj.setResPhi(   this->getObsRes(5,bin,theJet.et()) );	
    obj.setResET(    this->getObsRes(6,bin,theJet.et()) );	
    obj.setResEta(   this->getObsRes(7,bin,theJet.et()) );
  }
}
