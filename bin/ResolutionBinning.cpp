...
int main() {
  ...
  float etljets[2][100000],etaljets[2][100000];
  ...
  float etbjets[2][100000],etabjets[2][100000];
  ...
  //if (i=nrEtbins){
    cout << "metbin         " << "200"          << "    no eta-bin"    << endl;
  //}
